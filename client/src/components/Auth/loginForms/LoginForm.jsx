...
return (
  <form className={`row g-3 d-flex justify-content-center ${data.email||data.password !== '' ? "was-validated" : "needs-validation"}`} onSubmit={submitHandler} >
    ...
    <div className="col-md-4">
      ...
      <input type="text" className="form-control" onChange={onChange} name="password" value={data.password} placeholder="password" id="validationCustom02" required />
    ...
    {user?.loader?<CircularColor/>:""|| user?.user === null ? <DescriptionAlert /> : "" || data.error ? <DescriptionAlert2 /> : ""}
    </div>
    <div className="col-12 d-flex justify-content-center">
